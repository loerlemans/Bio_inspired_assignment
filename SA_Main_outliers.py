...
# Plotting the distribution of mission times
plt.hist(mission_times, bins=10, edgecolor='black')
plt.title('Sample distribution for UAV simulations')
plt.xlabel('Mission times (seconds)')
